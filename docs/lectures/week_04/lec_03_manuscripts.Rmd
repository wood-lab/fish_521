...
* Our writing is what moves our field forward, because it is what lasts.

> - papers (sometimes called manuscripts, MSes, publications, or pubs)
...
## Today, we focus on manuscripts and proposals

* Science is a global process of learning about nature.

> - It's nice if you learn something about nature...

> - ... but if you don't write it down, no one else knows it, and that knowledge is lost.

> - The way science preserves knowledge? papers.
...
> - reviews are often neglected, overdue, or rushed (this can take months)
...
Our findings are in line with previous studies showing the effect of temperature on growth. For example, the reference we cited (Smith 2020) presents rather compelling evidence that a difference of only 1.5 degrees C increased growth by 20%.
...
We agree with the reviewer that such an analysis could reveal some interesting patterns, but it is out of scope for this project given the resources and time required to undertake it.
...
> - pdfs of page proofs are produced & sent to the lead author
...
* Your homework assignment this week: write a draft Introduction for your thesis / dissertation proposal (a required SAFS Milestone).

> - the Introduction of a proposal is much the same as the Introduction to a manuscript

> - use the tools you learned today and in this week's readings/videos!
