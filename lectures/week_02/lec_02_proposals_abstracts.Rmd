...
> - Science is both the collection of facts we know about nature and the process by which we obtain those facts.

> - Science is the systematic study of nature by testing theories against evidence obtained.

> - Science is ongoing: it is a self-correcting process that (ideally) proceeds toward perfection (but never reaches it).

## What is the scientific method?

"a method of procedure that has characterized natural science since the 17th century, consisting in systematic observation, measurement, and experiment, and the formulation, testing, and modification of hypotheses."

## Let's step through the scientific method together

* Watch [this video](https://youtu.be/R2DU85qLfJQ?si=cDoutnJdv9U3StQ2&t=546)
* Get into pairs
* Work together to complete [this worksheet](https://wood-lab.github.io/fish_521/references/class_2_worksheet.docx). Feel free to use the whiteboards around the room to sketch things out as you're brainstorming.
* Consult [Garton et al. 2020](https://wood-lab.github.io/fish_521/references/Garton_et_al_2020.pdf) to make sure that your answers are complete
* Share your design with the rest of the class
* You will e-mail the worksheet to Chelsea before the end of class today, after a few more exercises...

## Trade-offs between certainty and scope of inference in experimental design

> - Figure 1.4 in [Garton et al. 2020](https://wood-lab.github.io/fish_521/references/Garton_et_al_2020.pdf) shows trade-offs between certainty and realism/scope of inference
> - Without consulting the figure, where would you place the following designs on axes (x = scope of inference, y = certainty): natural history observations, laboratory experiment, model, field experiment, replicated natural experiment, unreplicated natural experiment, multiple approaches

## Considerations in experimental design - check your design
...
## Proposals are not just for funding

A proposal is an opportunity to:

> - critically evaluate your planned research before you invest effort
> - receive feedback (from your PI, peers, other experts) before you invest effort
